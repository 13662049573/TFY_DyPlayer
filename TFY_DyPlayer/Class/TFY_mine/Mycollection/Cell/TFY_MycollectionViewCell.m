...
@interface TFY_MycollectionViewCell ()
...
@implementation TFY_MycollectionViewCell

+ (instancetype)infoCellWithTableView:(UITableView *)tableView{
    
    static NSString *Id = @"TFY_MycollectionViewCell";
    TFY_MycollectionViewCell *cell = [tableView dequeueReusableCellWithIdentifier:Id];
    if(!cell){
        cell = [[TFY_MycollectionViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:Id];
...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self=[super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        self.pic_imageView.tfy_LeftSpace(10).tfy_TopSpace(10).tfy_BottomSpace(10).tfy_Width(Width_W*1/3);
        
        [self.pic_imageView addSubview:self.pf_label];
        self.pf_label.tfy_LeftSpace(10).tfy_TopSpace(10).tfy_size(65, 25);
        ...
        self.name_label.tfy_LeftSpaceToView(10, self.pic_imageView).tfy_TopSpace(10).tfy_RightSpace(10).tfy_HeightAuto();
        
        [self.contentView addSubview:self.daoyan_label];
        self.daoyan_label.tfy_LeftSpaceToView(10, self.pic_imageView).tfy_TopSpaceToView(5, self.name_label).tfy_RightSpace(10).tfy_HeightAuto();
        
        [self.contentView addSubview:self.zhuyan_label];
        self.zhuyan_label.tfy_LeftSpaceToView(10, self.pic_imageView).tfy_TopSpaceToView(5, self.daoyan_label).tfy_RightSpace(10).tfy_HeightAuto();
        
        [self.contentView addSubview:self.type_label];
        self.type_label.tfy_LeftSpaceToView(10, self.pic_imageView).tfy_TopSpaceToView(5, self.zhuyan_label).tfy_Width(Width_W*2/3/2).tfy_Height(25);
        
        [self.contentView addSubview:self.hits_label];
        self.hits_label.tfy_RightSpace(10).tfy_Width(Width_W*2/3/2).tfy_TopSpaceToView(5, self.zhuyan_label).tfy_Height(25);
        
        [self.contentView addSubview:self.addtime_label];
        self.addtime_label.tfy_LeftSpaceToView(10, self.pic_imageView).tfy_RightSpace(10).tfy_TopSpaceToView(5, self.hits_label).tfy_Height(25);
    }
    return self;
}
...
-(UILabel *)name_label{
    if (!_name_label) {
        ...
        _name_label.tfy_textcolor(LCColor_B1, 1).tfy_fontSize([UIFont systemFontOfSize:14]).tfy_alignment(0).tfy_numberOfLines(0);
    }
    return _name_label;
}
...
-(UILabel *)type_label{
    if (!_type_label) {
        ...
        _type_label.tfy_textcolor(LCColor_B1, 1).tfy_fontSize([UIFont systemFontOfSize:14]).tfy_alignment(0).tfy_numberOfLines(0);
    }
    return _type_label;
}
...
-(UILabel *)hits_label{
    if (!_hits_label) {
        ...
        _hits_label.tfy_textcolor(LCColor_B1, 1).tfy_fontSize([UIFont systemFontOfSize:14]).tfy_alignment(2);
    }
    return _hits_label;
}
...
-(UILabel *)pf_label{
    if (!_pf_label) {
        _pf_label = tfy_label();
        _pf_label.tfy_textcolor(LCColor_B5, 1).tfy_fontSize([UIFont systemFontOfSize:13]).tfy_alignment(1).tfy_backgroundColor(@"1AA3F0", 1).tfy_cornerRadius(5);
    }
    return _pf_label;
}
...
-(UILabel *)state_label{
    if (!_state_label) {
        ...
        _state_label.tfy_textcolor(LCColor_B5, 1).tfy_fontSize([UIFont systemFontOfSize:13]).tfy_alignment(1);
    }
    return _state_label;
}
...
-(UILabel *)addtime_label{
    if (!_addtime_label) {
        ...
        _addtime_label.tfy_textcolor(LCColor_B1, 1).tfy_fontSize([UIFont systemFontOfSize:14]).tfy_alignment(1);
    }
